...
//addAuthor({name:"Jith",email:"jidesh0410@gmail.com",password:"hiHH12@#"})
//addBook({ name: "aafbc", authorUserId: 1 });
// addAuthor({name:"j",email:"hi#dh",password:"bug"})//error
// addBook({ name: "aafbc", authorUserId: 6 });//error
//viewAuthor( id: 7 );
//viewBook()

//updateBook({authorId:1,bookId:2,name:"aafbuc"});
// deleteBook(id=1)

//updateAuthor(1,{userName:"Jidesh"})
//updateAuthor(2,{userName:"future",email:"future123@gmail.com"})
// updateAuthor(3,{userName:"sun1",email:"sun@gmail.com",password:"sv568ED#"})
// deleteAuthor(3)
